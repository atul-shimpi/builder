...
class Exporter {
  ...
  private $virtualHostsPath;
	...
	private function createFolders(ProjectModel $project)	
	{
		//$name = $project->id;
$name = $project->name;
		if (is_dir($this->virtualHostsPath.$name)) {
			return $this->virtualHostsPath.$name.'/';
		}

		if (@mkdir($this->virtualHostsPath.$name)) {
			@mkdir($this->virtualHostsPath.$name.'/css');
			@mkdir($this->virtualHostsPath.$name.'/js');
			@mkdir($this->virtualHostsPath.$name.'/images');
			@mkdir($this->virtualHostsPath.$name.'/mail');
